...
(function (AS) {
  ...
  var TEXTS = {
    fr: {
      ...
      'm.first.title': 'Comment veux-tu jouer ?',
      'm.first.touch.body': 'Le classique : appuie à gauche ou à droite pour tourner, en haut pour sauter.',
      'm.first.tilt.body': "Incline ton téléphone pour tourner, secoue-le pour sauter — sans jamais toucher l'écran.",
      'm.first.tilt.note': 'Ton téléphone te demandera une autorisation.',
      'm.first.foot': 'Tu pourras changer ça à tout moment, depuis ce menu ou le menu Pause.',
      'a11y.controls': 'Changer de commandes',
      'pause.controls': 'Commandes',
      'pause.controls.touch': "Toucher l'écran",
      'pause.controls.tilt': 'Incliner le téléphone',
      'pause.controls.denied': "Ton téléphone a refusé l'accès aux capteurs. Les commandes tactiles restent actives. Tu peux réessayer depuis les réglages de Safari, section Mouvement et orientation.",
      'm.tuto.tilt.jump': "SECOUE le téléphone d'un coup sec pour sauter",
      'm.tuto.tilt.left': "INCLINE vers la gauche pour tourner à gauche",
      'm.tuto.tilt.right': "INCLINE vers la droite pour tourner à droite",
    ...
    en: {
      ...
      'm.tuto.go': 'GO !',
      'm.tuto.foot': "Mets le téléphone à la verticale pour la pause et les réglages.",
      'm.first.title': 'How do you want to play?',
      'm.first.touch.body': 'The classic: tap left or right to turn, up top to jump.',
      'm.first.tilt.body': 'Tilt your phone to turn, shake it to jump — without ever touching the screen.',
      'm.first.tilt.note': 'Your phone will ask for a permission.',
      'm.first.foot': 'You can change this any time, from this menu or the Pause menu.',
      'a11y.controls': 'Change controls',
      'pause.controls': 'Controls',
      'pause.controls.touch': 'Touch the screen',
      'pause.controls.tilt': 'Tilt the phone',
      'pause.controls.denied': 'Your phone refused access to the sensors. Touch controls stay active. You can try again from Safari settings, under Motion & Orientation.',
      'm.tuto.tilt.jump': 'SHAKE the phone sharply to JUMP',
      'm.tuto.tilt.left': 'TILT left to turn LEFT',
      'm.tuto.tilt.right': 'TILT right to turn RIGHT',
